...
import { CreateSSHKey } from '../../services/helper';
import 'bootstrap/dist/css/bootstrap.min.css';
import '../CreateProjectService.css';

const PostDataFormnew = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await CreateSSHKey(data);
...
export default PostDataFormnew;
