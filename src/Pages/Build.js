...
const navigate = useNavigate();
  ...
  const removePost = async (projectId) => {
    ...
    <div className="navDiv">
     ...
     <div className='services-list build'>
    <div className='row bottom test'>
      <div className='command-X command-one'>
   
    <div className='row titl-row build-main'>
     
    <div className='flx'>
       <div>
     <h6 className='build-h6'>state-KY-command-crawl_zillow_address_new</h6>
     <p className='build-p'>Build  | #12main |  HEAD</p>
     </div> 
     <div className='hey'>
      <p>failed</p>
      <div className='cross-div'><h3>X</h3></div>
     ...
     <div className='row row-2'><p>/script/batch.shh</p></div>
    {/* <ListProjectCommandsAPI /> */}
   <div><p>
A Rosen Created Thu 7th Sep at 8:32 AM Triggered from API</p></div>
     </div>
