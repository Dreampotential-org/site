...
//     // Send a DELETE request to delete the post with the given project ID
...
//     // Fetch the updated list of project services after deletion
//     fetchData();
//   } catch (error) {
...
//               type='button'
//               onClick={() => removePost(curElem.id)} // Pass the project ID to removePost function
//             >
//               -
//             </button>
//             </div>
